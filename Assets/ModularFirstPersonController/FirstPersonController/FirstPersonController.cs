...
public class FirstPersonController : MonoBehaviour
{
    ...
    public AudioSource RecogerColeccionable;
    ...
    void Start()
    {
        ...
        contador = 0;
        gameManager.PuntualizarMarcador(contador);
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.RecogerColeccionable = (AudioSource)EditorGUILayout.ObjectField(new GUIContent("Sonido Recoger Coleccionable"), fpc.RecogerColeccionable, typeof(AudioSource), true);
